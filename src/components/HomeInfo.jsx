  ...
  if (currentStage === 3)
    return (
      <h1 className='sm:text-xl sm:leading-snug text-center neo-brutalism-blue py-4 px-8 text-white mx-5 transition-all duration-700 ease-in-out transform translate-y-0 opacity-100 hover:translate-y-[-10px]'>
        Hi, I'm
        <span className='font-semibold mx-2 text-white'>Akanksha Pundir</span>
        👋
        <br />
        Final-Year CSE Student | SAP Hackfest & CDG Ideathon Finalist 🏆 | Android & AI Developer | 4⭐ C++ & Problem Solving @ HackerRank
      </h1>
    );
